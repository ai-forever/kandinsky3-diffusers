...
class KandinskyV3ControlnetPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    def process_embeds(self,embeddings, attention_mask, cut_context=False):
        if cut_context:
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                for i in range(len(control_hidden_states)):
                    control_hidden_states[i] = control_hidden_states[i] * controlnet_cond_scale
