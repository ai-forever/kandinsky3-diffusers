...
DUMMY_MODULES_FOLDER = "kandinsky3_diffusers.utils"
...
def load_sub_model(
    ...
    is_diffusers_model = issubclass(class_obj, kandinsky3_diffusers.ModelMixin)
...
class DiffusionPipeline(ConfigMixin, PushToHubMixin):
    ...
    def register_modules(self, **kwargs):
        ...
        from kandinsky3_diffusers import pipelines
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if pipeline_class.__name__ == "StableDiffusionInpaintPipeline" and version.parse(
            ...
            from kandinsky3_diffusers import StableDiffusionInpaintPipeline, StableDiffusionInpaintPipelineLegacy
    ...
    def download(cls, pretrained_model_name, **kwargs) -> Union[str, os.PathLike]:
        ...
        try:
            ...
            pipeline_class = getattr(kandinsky3_diffusers, cls_name, None)
