...
class KandinskyV3ControlnetPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    def process_embeds(self,embeddings, attention_mask):
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            prompt_embeds, attention_mask = self.process_embeds(prompt_embeds, attention_mask)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                for i in range(len(control_hidden_states)):
                    control_hidden_states[i] = control_hidden_states[i] * k
